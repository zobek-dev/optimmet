import { ConsultoriasCuadrada, CapacitacionesCuadrada, DesarrolloProyectosCuadrada } from "@/images";
...
export const OtrosAsesorias = () => {
  return(
    <section className="py-20 overflow-hidden">
      <div className="wrapper">
        <h2 className="text-center font-bold text-[30px] lg:text-[40px] leading-[1.2] mb-2">Otros <strong className="font-bold text-[#62CFF4]">Servicios</strong></h2>
