  ...
  return(
    <section className="hero-home">
      <div className="wrapper relative w-full h-full flex flex-col items-start justify-end pb-12 lg:pb-20 lg:pl-12">
        <figure className="bg-white py-6 px-6 max-w-[260px] sm:max-w-[520px] rounded-tl-[20px] rounded-tr-[8px] rounded-br-[20px] rounded-bl-[8px]">
        ...
        <Link href="/servicios" className="block bg-[#62CFF4] border border-[#62CFF4] py-2 px-6 w-max rounded-[32px] text-white text-[17px] my-4 font-medium transition-colors duration-200 ease-linear hover:bg-[#FFFFFF] hover:text-[#62CFF4]">
          Ver Servicios
        </Link>
