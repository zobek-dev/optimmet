  ...
  <section className="home-sobre">
    <div className="wrapper flex flex-col justify-center h-full relative">
      <div className="max-w-[684px]">
        ...
        <Link href="/nosotros" className="block mt-4 bg-[#C7E22B] text-[#08376B] text-[17px] font-medium px-4 py-2 w-max rounded-[32px] border border-[#C7E22B] transition-colors duration-200 ease-in-out hover:border-[#08376B] hover:text-[#C7E22B] hover:bg-[#08376B]">
          Sobre Optimmet
        </Link>
      </div>
